...
import { CONTRACT_ADDRESSES, BLOCKCHAIN_CONFIG, GAS_CONFIG } from "./blockchain-config";
...
class BlockchainService {
  ...
  private usersContract: ethers.Contract;
  private medicalContract: ethers.Contract;
  private treatmentsContract: ethers.Contract;
